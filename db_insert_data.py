...
regions = pd.read_csv('data/t_university.csv')

for index, region in regions.iterrows():
    value = University(id=region['id'], name=region['name'])
...
#     value = University(id=pr['id'], name=pr['name'], code=pr['code'], is_support=pr['is_support'])
#     db.session.add(value)
#
# db.session.commit()
#
